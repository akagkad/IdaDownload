...
namespace DeliveryBlocks.Model.CountryModel {
    class ESAndPTDeliveryBlocksProperty {
        ...
        [Column("[Csr Name]")] public string csrName { get; set; }

        public ESAndPTDeliveryBlocksProperty(ZV04HNProperty zv) {
            ...
            this.csrName = zv.csrasrName;
        }

        public override bool Equals(object obj) {
            return obj is ESAndPTDeliveryBlocksProperty property &&
                   ...
                   csrName == property.csrName;
        }

        public override int GetHashCode() {
            var hashCode = -1318817820;
            ...
            hashCode = hashCode * -1521134295 + EqualityComparer<string>.Default.GetHashCode(csrName);
            return hashCode;
        }
    }
}
